const Skeleton = () => {
  return (
    <div className="mx-auto flex w-full select-none flex-col gap-1 rounded-lg bg-gray-100 p-2 sm:h-64 sm:flex-row sm:p-4 ">
      <div className="h-32 animate-pulse rounded-xl bg-gray-200 sm:h-full sm:w-72"></div>
      <div className="flex flex-1 flex-col gap-1 sm:p-2">
