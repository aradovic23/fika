  ...
  return (
    ...
    >
      {({ getRootProps, getInputProps, acceptedFiles }) => (
        <Box {...getRootProps()} w="lg" onClick={handleRefClick}>
          <VStack h="full" w="full" justify="center" align="center">
            <label
              htmlFor="dropzone-file"
              className="flex h-full w-2/3 cursor-pointer flex-col items-center justify-center rounded-lg p-4 outline outline-2 outline-blue-300 hover:bg-blue-50"
            >
  ...
  return (
    ...
    >
      <Drawer.Trigger asChild onClick={() => setIsOpen(true)}>
        <Button variant="outline" colorScheme="martinique" _hover={{ bg: 'martinique.200' }}>
          Upload New Image
        </Button>
      </Drawer.Trigger>
